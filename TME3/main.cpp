...
int main () {
	...
	*/
	...
	cout << "Test de count " << TME3::count(list.begin(),list.end())<< endl;
	cout << "Test de count_if_equal avec le mot war: " << TME3::count_if_equal(list.begin(),list.end(),war) << endl;	
